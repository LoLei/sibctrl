...
class Headset(object):
    ...
    def set_color(self, red, green, blue):
        ...
        print("Product name: {}".format(self.handle.getProduct()))
        commands = (
        ...
        commands.append(bytearray(b"\x04\x40\x01\x11\x54\x9b\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"))
        commands.append(bytearray(b"\x06\x8a\x42\x00\x20\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"))
        ...
        commands.append(bytearray(b"\x06\x81\x43\x01\x23\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"))
        commands.append(bytearray(b"\x06\x8a\x42\x00\x20\x41\x00\xff\xea\x00\xff\x52\x00\xc8\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"))
